//
// Generated file, do not edit! Created by opp_msgc 4.5 from src/node/application/ApplicationPacket.msg.
//
...
void ApplicationPacket::copy(const ApplicationPacket& other)
{
    ...
    this->data2_var = other.data2_var;
}
...
int ApplicationPacket::getData2() const
{
    return data2_var;
}

void ApplicationPacket::setData2(int data2)
{
    this->data2_var = data2;
}
...
int ApplicationPacketDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='d' && strcmp(fieldName, "data2")==0) return base+4;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}
...
std::string ApplicationPacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 4: return double2string(pp->getData2());
        default: return "";
    }
}
...
bool ApplicationPacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 4: pp->setData2(string2double(value)); return true;
        default: return false;
    }
}

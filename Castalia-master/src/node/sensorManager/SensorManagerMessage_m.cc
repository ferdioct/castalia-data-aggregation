//
// Generated file, do not edit! Created by opp_msgc 4.5 from src/node/sensorManager/SensorManagerMessage.msg.
//
...
void SensorReadingMessage::copy(const SensorReadingMessage& other)
{
    ...
    this->sensedValue2_var = other.sensedValue2_var;
...
void SensorReadingMessage::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->sensedValue2_var);
...
void SensorReadingMessage::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->sensedValue2_var);
...
int SensorReadingMessage::getSensedValue2() const
{
    return sensedValue2_var;
}

void SensorReadingMessage::setSensedValue2(int sensedValue2)
{
    this->sensedValue2_var = sensedValue2;
}
...
int SensorReadingMessageDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "sensedValue2")==0) return base+1;
    if (fieldName[0]=='s' && strcmp(fieldName, "sensorType")==0) return base+2;
    if (fieldName[0]=='s' && strcmp(fieldName, "sensorIndex")==0) return base+3;
...
std::string SensorReadingMessageDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return double2string(pp->getSensedValue2());
        case 2: return oppstring2string(pp->getSensorType());
        case 3: return long2string(pp->getSensorIndex());
        default: return "";
    }
}
...
bool SensorReadingMessageDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setSensedValue2(string2double(value)); return true;
        case 2: pp->setSensorType((value)); return true;
        case 3: pp->setSensorIndex(string2long(value)); return true;

//
// Generated file, do not edit! Created by opp_msgc 4.5 from src/node/communication/mac/maftMac/MaftPacket.msg.
//
...
int MaftPacketDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='n' && strcmp(fieldName, "newCH")==0) return base+9;
...
std::string MaftPacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 9: return long2string(pp->getNewCH());
...
bool MaftPacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 9: pp->setNewCH(string2long(value)); return true;
